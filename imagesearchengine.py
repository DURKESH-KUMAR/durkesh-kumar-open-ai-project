...
x.say("image search engine will  open sooner please wait ")
...
lbl=Label(root,text="PERAK OS DISTRIBUTION IMG-SEARCH")
...
btn.pack(side=RIGHT)
img=PhotoImage(file="imagesearchengine.png")
lbl1=Label(root,image=img)
lbl1.config(width=1000, height=500)
lbl1.pack()
def sample():
    import webbrowser
    webbrowser.open("https://durkesh-imagesearch-engine.netlify.app")
    

btn=Button(root,text="SEARCH",command=sample)
