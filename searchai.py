...
x.say("your search ai will open sooner please wait ")
...
lbl=Label(root,text="PERAK OS DISTRIBUTION SEARCH AI")
...
btn.pack(side=RIGHT)
img=PhotoImage(file="searchai.png")
