...
x.say("the program will run sooner please wait ")
...
lbl=Label(root,text="PERAK OS DISTRIBUTION ON MATRIX RAIN")
...
lbl1.pack()
def sample():
    os.system("python rangoli.py")
    

btn=Button(root,text="RAIN",command=sample)
